...
[ConsoleClassCustomizer("Character")]
public class CharacterRagdoll : MonoBehaviour
{
	// Token: 0x060001FD RID: 509 RVA: 0x0000F928 File Offset: 0x0000DB28
	private void Awake()
	{
	...
	// Token: 0x060001FE RID: 510 RVA: 0x0000F960 File Offset: 0x0000DB60
	private void Start()
	{
	...
	// Token: 0x060001FF RID: 511 RVA: 0x0000FA3C File Offset: 0x0000DC3C
	...
	// Token: 0x06000200 RID: 512 RVA: 0x0000FAA0 File Offset: 0x0000DCA0
	...
	// Token: 0x06000201 RID: 513 RVA: 0x0000FAD8 File Offset: 0x0000DCD8
	...
	// Token: 0x06000202 RID: 514 RVA: 0x0000FB1E File Offset: 0x0000DD1E
	...
	// Token: 0x06000203 RID: 515 RVA: 0x0000FB3A File Offset: 0x0000DD3A
	...
	// Token: 0x06000204 RID: 516 RVA: 0x0000FB5C File Offset: 0x0000DD5C
	...
	// Token: 0x06000205 RID: 517 RVA: 0x0000FBB0 File Offset: 0x0000DDB0
	...
	// Token: 0x06000206 RID: 518 RVA: 0x0000FBC0 File Offset: 0x0000DDC0
	...
	// Token: 0x06000207 RID: 519 RVA: 0x0000FC64 File Offset: 0x0000DE64
	...
	// Token: 0x06000208 RID: 520 RVA: 0x0000FD1C File Offset: 0x0000DF1C
	...
	// Token: 0x06000209 RID: 521 RVA: 0x0000FE28 File Offset: 0x0000E028
	...
	// Token: 0x0600020A RID: 522 RVA: 0x0000FE7C File Offset: 0x0000E07C
	...
	// Token: 0x0600020B RID: 523 RVA: 0x0000FEF2 File Offset: 0x0000E0F2
	...
	// Token: 0x0600020C RID: 524 RVA: 0x0000FF1F File Offset: 0x0000E11F
	private void ResetRotation()
	{
		this.character.refs.rigCreator.transform.rotation = this.rotationBefore;
	}

	// Token: 0x0600020D RID: 525 RVA: 0x0000FF44 File Offset: 0x0000E144
	...
	// Token: 0x0600020E RID: 526 RVA: 0x000101F4 File Offset: 0x0000E3F4
	...
	// Token: 0x0600020F RID: 527 RVA: 0x00010260 File Offset: 0x0000E460
	public void SetRigDamping(float dampingValue)
	{
		foreach (Rigidbody rigidbody in this.rigidbodies)
		{
			rigidbody.linearDamping = dampingValue;
		}
	}

	// Token: 0x06000210 RID: 528 RVA: 0x000102B4 File Offset: 0x0000E4B4
	...
	// Token: 0x06000211 RID: 529 RVA: 0x00010334 File Offset: 0x0000E534
	...
	// Token: 0x06000212 RID: 530 RVA: 0x00010390 File Offset: 0x0000E590
	[ConsoleCommand]
	public static void SetKinematic(bool kinematic)
	{
		foreach (Player player in PlayerHandler.GetAllPlayers())
		{
			if (!player.character.IsLocal)
			{
				player.character.refs.ragdoll.ToggleKinematic(kinematic);
			}
		}
	}
